...
import { onAuthChange, getUserDocument, logout as firebaseLogout, ADMIN_EMAIL, updateUserRole } from '@/lib/firebase';
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const fetchUserData = async (uid: string, email: string) => {
    try {
      ...
      // If no user document, userData remains null (user needs to complete registration)
    } catch (error) {
